...
def main():
    ...
    parser.add_argument("--repo", help="Target 'owner/repo' of a single repository.")
    parser.add_argument("--commit", help="Global commit SHA (fallback if --targets or --repo not used)")
    ...
    if args.targets:
        ...
        targets = [{"repo": args.repo, "commit_sha": args.commit}]
        ...
        pr_error("You must provide either --targets OR --repo + --commit OR both --commit and --students.")
        sys.exit(1)
